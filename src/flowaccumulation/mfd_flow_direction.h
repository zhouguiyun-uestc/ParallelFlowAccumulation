...
bool getBigData( Raster< int >& dir, Raster< uint8_t >& bigDir, const int tileRow, const int tileCol, const int gridHeight, const int gridWidth, const std::string pathDir,
                 const std::string filenameDir );
void setborder( const int i, Raster< float >& bigDEM, Raster< float >& iDEM );
bool getBigData( Raster< float >& dem, Raster< float >& bigDEM, const int tileRow, const int tileCol, const int gridHeight, const int gridWidth, const std::string pathDEM,
                 const std::string filenameDEM );
