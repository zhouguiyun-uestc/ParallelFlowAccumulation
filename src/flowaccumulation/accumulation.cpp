...
#pragma region first round compute flow accumulation
...
#pragma region second round compute flow accumulation
void FlowAccumulationTradition( Raster< float >& dem, Raster< uint8_t >& flowdirs, Raster< double >& accum, Producer2Consumer* p2c ) {
    ...
    int tempRow, tempCol;
    for ( int i = 0; i < p2c->outer_accum.size(); i++ ) {
